...
const landingpage = () => {
  return (
    <div>
      <body>
        <div className="mt-10 absolute top-1/2 left-1/3 transform -translate-x-1/2 -translate-y-1/2">
          <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <p className="mb--10 font-normal text-zinc-300">
              <br></br>
              <br></br>
        ...
        <div className="mt-10 absolute top-1/2 right-14 transform -translate-x-1/2 -translate-y-1/2">
          <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#Proceed">
              <h5 className="mb-2 text-2xl font-bold tracking-tight text-center text-gray-900  dark:text-white">
                MINI-GAMES
